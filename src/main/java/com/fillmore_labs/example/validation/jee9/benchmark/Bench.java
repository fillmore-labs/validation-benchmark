package com.fillmore_labs.example.validation.jee9.benchmark;

import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static org.openjdk.jmh.annotations.Mode.AverageTime;

import com.fillmore_labs.example.validation.jee9.self_validating.Person;
import com.fillmore_labs.example.validation.jee9.validated.PersonFactory;
...
public /* open */ class Bench {
  ...
  public final com.fillmore_labs.example.validation.jee9.validated.Person validated(
      MyState myState) {
